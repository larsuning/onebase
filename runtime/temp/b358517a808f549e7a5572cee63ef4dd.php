<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\PHPTutorial\WWW\geek\public/../app/ps\view\inspection\sorting_area.html";i:1533728066;}*/ ?>
<style>
    .addA {
    width: 100vw;
    height: 100vh; 
        ...
        <div class="box-tools">
            <div class="input-group input-group-sm search-form">
                ...
                <div class="input-group-btn">
                    <button type="button" id="search" url="<?php echo url('sortingarea'); ?>" class="btn btn-default"><i class="fa fa-search"></i></button>
                </div>
            </div>
        </div>
    </div>
