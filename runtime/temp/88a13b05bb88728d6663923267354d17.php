...
<div class="box">
    <div class="box-header">
        ...
        <ob_link><a class="btn" href="<?php echo url('curdcreateAdd'); ?>"><i class="fa fa-plus"></i> 新 增</a></ob_link>
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td class="col-md-2 text-center">
                            <ob_link><a href="<?php echo url('curdcreateEdit', array('id' => $vo['id'])); ?>" class="btn"><i class="fa fa-edit"></i> 编 辑</a></ob_link>
                            &nbsp;
                            <ob_link><a class="btn confirm ajax-get"  href="<?php echo url('curdcreateDel', array('id' => $vo['id'])); ?>"><i class="fa fa-trash-o"></i> 删 除</a></ob_link>
                        </td>
                    </tr>
