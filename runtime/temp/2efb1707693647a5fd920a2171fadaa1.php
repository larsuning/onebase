...
option = {
    ...
    xAxis: {
        data: ['驯鹿（0.00 - 0.05）', '火箭（0.05 - 0.10）', '飞机（0.10 - 0.20）', '高铁（0.20 - 0.50）', '轮船（0.50 - 1.00）', '汽车（1.00 - 2.00）', '跑步（2.00 - 5.00）', '步行（5.00 +）', ],
        axisTick: {show: false},
        axisLine: {show: false},
        axisLabel: {
            textStyle: {
    ...
    series: [{
        ...
        data: ["<?php echo $data[0]; ?>", "<?php echo $data[1]; ?>", "<?php echo $data[2]; ?>", "<?php echo $data[3]; ?>", "<?php echo $data[4]; ?>", "<?php echo $data[5]; ?>", "<?php echo $data[6]; ?>", "<?php echo $data[7]; ?>"],
        z: 10
    }, {
        name: 'glyph',
        type: 'pictorialBar',
