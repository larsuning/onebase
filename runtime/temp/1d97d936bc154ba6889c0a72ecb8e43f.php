    ...
    <div class="box-header">
        ...
        <div class="col-md-2">
                    <div class="form-group" >
                        ...
                        <input type="text" class="pull-left search-input date" name="" value="" id="selectPurchase" placeholder="选择日期">
                    </div>
                </div>
        ...
        <table  class="table table-bordered table-hover">
            ...
            <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): ?>
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo $vo['shift']; ?><?php echo $vo['name']; ?></td>
                        <td><?php echo $vo['goods_batch']; ?></td>
                        <td><?php echo $vo['create_time']; ?></td>
                        <td><?php echo $vo['status_text']; ?></td>
                        <td class="col-md-2 text-center">
                            <ob_link><a href="<?php echo url('inspectionEdit', array('id' => $vo['id'])); ?>" class="btn"><i class="fa fa-edit"></i> 审核</a></ob_link>
                            &nbsp;
