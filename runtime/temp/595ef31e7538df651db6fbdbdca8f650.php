...
<!--      <form action="#" method="get" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <div class="box">
        <div class="box-body">
            <div class="row">
                 <?php if(empty(input('review')) || ((input('review') instanceof \think\Collection || input('review') instanceof \think\Paginator ) && input('review')->isEmpty())): ?>
                    <div class="col-md-6">
                    ...
                    <?php endif; ?>
              <table class="table table-bordered" style="margin: 5px" id="packing">
                <thead>
                    <tr>
                      <!-- <th>#</th> -->
                        <th>商品名称</th>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($list) ? array_slice($list,1,null, true) : $list->slice(1,null, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> 
                     <tr data-id="<?php echo $vo['id']; ?>"> 
                        ...
                        <td> <select name="is_qualified" id="">
                            ...
                            <option value="1" <?php if($vo['is_qualified'] == '1'): ?> selected<?php endif; ?>>有</option>
                        </select> </td>
                        ...
                        <td><textarea name="" id="" class="form-control" ><?php echo $vo['remark']; ?></textarea> </td>
                    </tr>
...
<script type="text/javascript">
    ...
    $('.finish').click(function(){
          var confirm = '';
        $('#packing input,textarea').each(function(){
            if($(this).val() == ''){
                $(this).focus();
                confirm = false;
        ...
        _id = $('#packing tr').eq(1).attr('data-id');
    ...
    $('.review').click(function(){
     ...
     $("#selectPurchase").selectPage({
                showField: 'sn',
                keyField: 'id',
                data: '/ps/inspection/packing?action=getPurchase&mark=1&type=4',
                pageSize: 8,
                        ...
                        if(d.code == '1'){
                            ...
                            $.each(d.data,function(index, item) {
                               ...
                               content += '<tr data-id="'+item.id+'">' +
                                ...
                                '<td> <select name="is_certificate" id=""><option value="0">无</option><option value="1" '+selected+'>有</option></select>  </td>' +
                                ...
                                '<td> <textarea type="text" value="" name="remark" >'+item.remark+'</textarea></td>' +
