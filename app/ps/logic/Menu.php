    ...
    public function menuToCheckboxView($menu_list = [], $child = 'child')
    {
        ...
        foreach ($menu_list as $menu_info) {
            ...
            if (!empty($menu_info[$child])) {
                ...
                $menu_view.=  "<div class='box box-header ps-node-header'>
                ...
                $menu_view.=    "<label class='ps-node-label'>  <input type='checkbox' name='rules[]' value='".$menu_info['id']."'  $checkbox_select > &nbsp;<i class='fa $icon'></i>  ".$menu_info['name']."  </label>";
            }
       }
